...
module.exports = function (error_type, res, options) {
	var info_render = {};
	var file_name = "";
	var lib  = path.join(path.dirname(fs.realpathSync(__filename)), '../');
	var path_templ = lib + 'template/errors/';
	if (error_type == "routes") {
		info_render.info = 'No route matches ['+options.method+'] &quot;'+options.url_path+'&quot;';
	...
	} else if (error_type == "argument_error") {
		info_render = options;
		file_name = "argument_error.html";
	}
